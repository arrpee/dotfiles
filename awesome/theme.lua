...
theme.titlebar_floating_button_normal = theme.icon_path .. "titlebar/floating/floating_1.svg"
theme.titlebar_floating_button_focus = theme.icon_path .. "titlebar/floating/floating_2.svg"
